...
class AuthorListViewTest(TestCase):
    ...
    def test_lists_all_authors(self):
        #Получите первую страницу и подтвердите, что на ней (точно) осталось 3 элемента
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def setUp(self):
        ...
        def test_form_invalid_renewal_date_past(self):
            ...
            self.assertEqual(resp.status_code, 200)
            self.assertFormError(resp, 'form', 'renewal_date', 'Недействительная дата - продление в прошлом')
        ...
        def test_form_invalid_renewal_date_future(self):
            ...
            self.assertEqual(resp.status_code, 200)
            self.assertFormError(resp, 'form', 'renewal_date', 'Недействительная дата - продление более чем на 4 недели вперед')